  ...
  var SEED = {
    ...
    candidates:[
      ...
      { id:"p2", name_ja:"デウィ・レスタリ", name_id:"Dewi Lestari", company_id:"c1",
        ...
        license:{ application_date:"", written_date:"", skill_date:"", result:"notyet", app_installed:false, app_freq:0, app_lastused:"", mocks:[] },
      ...
      { id:"p3", name_ja:"ブディ・ウタモ", name_id:"Budi Utomo", company_id:"c2",
        ...
        license:{ application_date:"2026-04-10", written_date:"2026-05-20", skill_date:"2026-06-30", result:"inprog", app_installed:true, app_freq:5, app_lastused:"2026-06-22",
      ...
      { id:"p5", name_ja:"リョ・ハルトノ", name_id:"Rio Hartono", company_id:"c3",
        ...
        license:{ application_date:"2026-01-15", written_date:"2026-02-20", skill_date:"2026-03-25", result:"done", app_installed:true, app_freq:3, app_lastused:"2026-03-20",
